...
class Ejemplo_filter_or extends Template_controller {
	...
	public function index(){
		$title = 'Filtro OR';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/ejemplo_filter_or',array('grid'=>$grid),TRUE);
	...
	public function serverProcessing(){
        ...
        array_push($array_qtype,array('TIPOS_DATOS_GRID.TDG_NUMBER',GRID_OR));
