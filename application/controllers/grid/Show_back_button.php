...
class SHOW_BACK_BUTTON extends Template_controller {
	...
	public function index(){
		$title = 'Config setShowBackButton (BOOLEAN)';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/show_back_button',array('grid'=>$grid),TRUE);
	...
	private function gConfig(){
		...
		$config['showCONTENT']['url'] = 'grid/ejemplo_back_button';
