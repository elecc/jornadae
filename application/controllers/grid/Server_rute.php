...
class SERVER_RUTE extends Template_controller {
	...
	public function index(){
		$title = 'Config server_rute (STRING)';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/server_rute',array('grid'=>$grid),TRUE);
