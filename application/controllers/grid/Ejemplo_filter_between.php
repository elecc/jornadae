...
class Ejemplo_filter_between extends Template_controller {
	...
	public function index(){
		$title = 'Filtro BETWEEN';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/ejemplo_filter_between',array('grid'=>$grid),TRUE);
