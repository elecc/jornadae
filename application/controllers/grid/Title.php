...
class TITLE extends Template_controller {
	...
	public function index(){
		$title = 'Config sTitle (STRING)';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/title',array('grid'=>$grid),TRUE);
