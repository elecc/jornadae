...
class Error_message_funcion extends Template_controller {
	...
	public function index(){
		$title = 'Propiedad ERROR_MESSAGE_FUNCION';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/error_message_funcion',array('grid'=>$grid),TRUE);
