...
class SHOW_CONTENT extends Template_controller {
	...
	public function index(){
		$title = 'Config showCONTENT (BOOLEAN,URL,TEXT_COLUMN)';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/show_content',array('grid'=>$grid),TRUE);
	...
	public function ejemploCONTENT(){
