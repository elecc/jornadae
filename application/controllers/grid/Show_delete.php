...
class SHOW_DELETE extends Template_controller {
	...
	public function index(){
		$title = 'Config showDELETE BOOLEAN';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/show_delete',array('grid'=>$grid),TRUE);
