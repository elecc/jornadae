...
class SHOW_EXPORT extends Template_controller {
	...
	public function index(){
		$title = 'Config showEXPORT(BOOLEAN)';
		$grid = $this->control();
		$view = $this->load->view('documentation_grid_views/show_export',array('grid'=>$grid),TRUE);
