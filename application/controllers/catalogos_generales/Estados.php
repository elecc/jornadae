...
class Estados extends Template_controller {
	...
	private function gConfig(){
		...
		$config['db']['connection_string'] = '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.1.130.24)(PORT=1521))(CONNECT_DATA=(SID=orcl)))';
