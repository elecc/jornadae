<?php  
class Modelo_partidoeleccion extends CI_Model{	
	...
	/***********************************************************************************************************************************************/
	//METODOS DEL SISTEMA	
	public function insertar_Pelecc($partido_elecc,$eleccion,$crapido,$jornadae){
		$id_eleccpart = $this->consultar_consecutivo('id_eleccionpartido','eleccionpartido');
		$usuario_creacion = 1;			//TIPO NUMBER
		$usuario_modificacion = 1;			//TIPO NUMBER

		$sql = "insert into eleccionpartido
        (id_eleccionpartido,id_eleccion,id_partido,crapido,id_jornada,
        usuariocreacion,usuariomodificacion,fechamodificacion,activo) "
		."VALUES(".$id_eleccpart.",".$eleccion.",".$partido_elecc.",".$crapido.",".$jornadae.","
