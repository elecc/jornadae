<?php  
class Modelo_independientes extends CI_Model{	
	...
	/***********************************************************************************************************************************************/
	//METODOS DEL SISTEMA	
	public function insertar_independiente($nombreind,$paternoind,$maternoind,$eleccion,$crapido){
		$id_indepen = $this->consultar_consecutivo('id_independiente','independiente');
		$usuario_creacion = 1;			//TIPO NUMBER
		$usuario_modificacion = 1;			//TIPO NUMBER

		$sql = "insert into independiente
        (id_independiente,nombre,apellidopaterno,apellidomaterno,
        usuariocreacion,usuariomodificacion,fechamodificacion,activo, id_eleccion) "
		."VALUES(".$id_indepen.",'".$nombreind."','".$paternoind."','".$maternoind."',"
        .$usuario_creacion.",".$usuario_modificacion.",current_date,1,".$eleccion.")";
