			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header   bg-primary">
						...
						<h4 class="modal-title">Captura de votos conteo rápido</h4>
						<hr />
						<address>
					...
					<div class="modal-body">
						...
						<form id_="form_independientes" name="form_independientes">
							...
							<div class="form-group">
								...
								<input type="text" name="casilla" class="form-control" id="casilla" placeholder="Casilla">
							</div>
							<div class="form-group">
								<label for="partido1">PART1</label>
								<input type="text" name="part1" class="form-control" id="part1" placeholder="Votos">
							</div>
						</form>
					</div>
