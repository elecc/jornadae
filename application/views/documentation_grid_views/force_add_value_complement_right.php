<div id="zonaTrabajo">
<p><h1>Propiedad FORCE_ADD_VALUE_COMPLEMENT_RIGHT</h1></p>

<p>FORCE_ADD_VALUE_COMPLEMENT_RIGHT agrega un TEXTO a la izquierda del valor original, este no se guarda en la base de datos solo se muestra en el GRID</p>
